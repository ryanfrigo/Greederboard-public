; (function () {
    ...
    Game.prototype = {
        ...
        draw: function () {
            ...
            if (this.lost) {
                screen.fillStyle = "rgba(255, 0, 0, 0.08)";
                screen.fillRect(0, 0, gameSize.width, gameSize.height);

                screen.font = "20px Courier";
                screen.textAlign = "center";
                screen.fillStyle = "black";
                screen.fillText("Greederboard ~ 404", gameSize.width / 2, gameSize.height / 2);
                screen.font = "15px Courier";
                screen.fillText(kills, gameSize.width / 2, gameSize.height / 2 + 30);

            } else {
                screen.clearRect(0, 0, gameSize.width, gameSize.height);

                screen.font = "10px Courier";
                screen.textAlign = "right";
                screen.fillText(kills, gameSize.width, gameSize.height - 12);
            }
